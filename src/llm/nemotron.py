...
class NemotronProvider(LLMProvider):
    """Nemotron 3.5 Lightning Free provider via NVIDIA API."""
    ...
    async def initialize(self) -> None:
        ...
        if not self.api_key:
            raise ValueError("NEMOTRON_API_KEY environment variable not set")
    ...
    async def complete(
        ...
        try:
            ...
            raise RuntimeError(f"Nemotron completion failed: {e}")
    ...
    async def stream_complete(
        ...
        try:
            ...
            raise RuntimeError(f"Nemotron streaming failed: {e}")
