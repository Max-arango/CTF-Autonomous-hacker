...
class NIMProvider(LLMProvider):
    ...
    async def initialize(self) -> None:
        if not self.api_key:
            raise ValueError("NIM_API_KEY environment variable required")
    ...
    async def complete(
        ...
        nim_messages = self._convert_messages(messages)
        ...
        try:
            ...
            raise RuntimeError(f"NIM completion failed: {e}")
    ...
    async def stream_complete(
        ...
        try:
            ...
            raise RuntimeError(f"NIM streaming failed: {e}")
